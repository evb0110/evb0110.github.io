var xt=Object.defineProperty;var kt=(t,e,n)=>e in t?xt(t,e,{enumerable:!0,configurable:!0,writable:!0,value:n}):t[e]=n;var X=(t,e,n)=>kt(t,typeof e!="symbol"?e+"":e,n);import{M as q,c as S,a4 as Lt,b as et,aw as wt,t as Dt,r as w,w as it,b3 as Gt,o as g,f as p,n as at,D as Z,A as Ut,p as A,F as L,i as $,g as Y,h as D,j as G,k as F,ax as T,V as U,m as tt,_ as nt}from"./index-D0OqDj35.js";import{V as $t}from"./VTextField-AgraXwb7.js";import{b as Ft}from"./betterSplit-CW8NIeFU.js";var V=(t=>(t.title="title",t.textus="textus",t.versio="versio",t))(V||{});const Pe=["title","textus","versio"];var jt=(t=>(t.search="search",t.browse="browse",t))(jt||{});const Je=["search","browse"],Bt="(?:a|e|i|iͧ|o|u|ä|å|ë|ö|ü|á|á̧|â|ä|å|é|ê|ë|í|î|ó|ô|ö|ú|û|ü|ā|ā́|ă|ą̂|ē|ĕ|ī|ı|ō|ŏ|ū|ŭ|ŭ́|ə|ə́|и|о|ю|ạ|ạ|ạ́|ậ|ắ|ẹ|ọ|ộ|ụ|ụ̂|а|о|у|э|ы|и|ь)",Ht="(?:b|b́|c|c̄|d|f|f̣|g|h|j|k|k̇|l|m|n|n̄|p|p̄|p̣|q|q̣|r|r̄|r̄̄|s|s̄|t|t́|v|w|x|y|z|z̄|ç|ć|č|ğ|ġ|ģ|ķ|ń|ň|ŕ|ś|ŝ|ş|ş́|ş̇|š|ţ|ž|ǧ|ǧ̣|Ɂ|ɧ|ʔ|ʕ|ʕ́|ʕ̣|ʾ|ʿ|б|в|й|к|п|р|с|т|х|ҫ|ҫ́|ҫ̂|ҫ̄|ع|ḅ|ḇ|ḉ|ḍ|ḏ|ḏ̣|ḏ̣̣|ḥ|ḳ|ḳ̇|ḷ|ṃ|ṅ|ṇ|ṗ|ṛ|ṝ|ṡ|ṣ|ṫ|ṭ|ṯ|ẓ|ẖ|ﻉ)",Kt=new RegExp("[\\\\]v","gi"),Yt=new RegExp("[\\\\]c","gi"),qt=q.memoize(function(e){return e.replace(Kt,Bt).replace(Yt,Ht)});class z{constructor(e){X(this,"_value");this._value=e||""}get value(){return this._value}set value(e){this._value=e||""}get valueNormalized(){return qt(this.value)}get isEmpty(){return!this.value}get regex(){return RegExp(this.valueNormalized,"iu")}static instantiate(e){return new z(e)}}class ze{constructor(e){X(this,"data");this.data=q.mapValues(e,z.instantiate)}get searchersArr(){return q.values(this.data)}get areAllEmpty(){return this.searchersArr.every(e=>e.isEmpty)}get test(){return e=>q.keys(this.data).every(n=>this.data[n].regex.test(e[n]))}}var P=(t=>(t.turoyo="turoyo",t.urmi="urmi",t.maalula="maalula",t))(P||{});const Vt=()=>{const t=Lt();return S(()=>t.path.split("/")[1])};function Pt(t){return new Promise(e=>setTimeout(e,t))}const Jt="a á ä ā b ḅ c č ç d ḍ ḏ ḏ̣ e é ē ə f g ǧ ġ ģ h ḥ i í î ī ı j k ḳ l m ṃ ň ṇ o ó ö p q r ṛ s š ṡ ş ṣ t ţ ṭ ṯ u ú ü ụ v w x y z ž ʔ ʕ",zt=Jt.split(/\s+/),Wt="a ä b ʙ c č ç d e ǝ ə f g Ģ h i I ı j k l m n o ö p q r s ş ṣ ș t ţ ṭ ț u ü v w x y z ž ƶ а ә б в г д е ж з и й к л м н о п р с т у ф х һ ц ч ш щ ъ ы ь э ю я",Xt=Wt.split(/\s+/),Qt="ʔ ʕ a á ā b c ć č d ḍ ḏ ḏ̣ e é ē ə f g ǧ ġ h ḥ i í ī k ḳ l ḷ m n o ō p r s š ṣ t ṭ ṯ u ú ū w x y z ž ẓ",Zt=Qt.split(/\s+/),te={[P.turoyo]:zt,[P.urmi]:Xt,[P.maalula]:Zt},ee=()=>{const t=Vt();return S(()=>te[t.value])},ne={class:"working-block"},se={class:"keyboard specific-keys"},oe={key:1,class:"keyboard common-keys"},ie={key:2,class:"submit-wrapper"},ae=et({__name:"Keyboard",props:{value:{default:""},inputName:{default:""},visible:{type:Boolean,default:!1},type:{default:"full"},inputEl:{default:null}},emits:["submit","update:visible"],setup(t,{emit:e}){const n=e,s=wt(),o=Dt(s,"isDark"),i=w(0),a=w(0),l=w(null),r=w(t.value),E=[String.raw`\v`,String.raw`\c`,"^","$","\\"],m=["⬅","space","del","backspace","⮕"],y=ee(),c=w(null);it(()=>{c.value=l.value||t.inputEl},{flush:"sync"}),it(()=>{r.value=t.value});function u(f){r.value=f,ot()}function v(){n("update:visible",!1)}function O(){n("submit",r.value),v()}function ot(){var f,h;i.value=((f=c.value)==null?void 0:f.selectionStart)||0,a.value=((h=c.value)==null?void 0:h.selectionEnd)||0}async function Tt(){await Pt(20),ot()}function W(f,h){if(!c.value)return;const d=r.value||"";i.value=c.value.selectionStart||0,a.value=c.value.selectionEnd||0;const{buttonValueMod:I,selectionStartMod:_,selectionEndMod:R}=Mt({buttonValue:f,selectionStart:i.value,selectionEnd:a.value,existingValue:d});c.value.value=d.slice(0,_)+I+d.slice(R,d.length),r.value=c.value.value,c.value.focus(),i.value=c.value.selectionStart=_+I.length,a.value=c.value.selectionEnd=_+I.length,t.type==="regex"&&n("submit",r.value)}Gt(()=>{l.value=document.querySelector(".keyboard-wrapper .v-text-field input"),i.value=a.value=t.value.length});function Mt({buttonValue:f,selectionStart:h,selectionEnd:d,existingValue:I}){let _,R=h,x=d;return f==="backspace"?(h>0&&h===d&&(R=h-1),_=""):f==="del"?(h<I.length&&h===d&&(x=d+1),_=""):f==="space"?_=" ":f==="⬅"?(h<d?x=h:(R=Math.max(0,h-1),x=R),_=""):f==="⮕"?(h<d?R=d:(R=Math.min(I.length,h+1),x=R),_=""):(_=f,R=h,x=d),{buttonValueMod:_,selectionStartMod:R,selectionEndMod:x}}return(f,h)=>f.visible?(g(),p("div",{key:0,class:T([f.type,"keyboard-wrapper"])},[at("div",ne,[f.type==="full"?(g(),Z($t,{key:0,label:f.inputName,"model-value":r.value,class:"input",density:"compact",variant:"outlined",clearable:"",onFocus:Tt,"onUpdate:modelValue":u,onKeyup:Ut(O,["enter","native"])},null,8,["label","model-value"])):A("",!0),at("div",se,[E?(g(),p(L,{key:0},$(E,d=>Y(U,{key:d,color:"warning",variant:"outlined",class:T({invert:o.value}),rounded:"",onClick:I=>W(d)},{default:D(()=>[G(F(d),1)]),_:2},1032,["class","onClick"])),64)):A("",!0),tt(y)&&f.type==="full"?(g(!0),p(L,{key:1},$(tt(y),d=>(g(),Z(U,{key:d,variant:"outlined",rounded:"",onClick:I=>W(d)},{default:D(()=>[G(F(d),1)]),_:2},1032,["onClick"]))),128)):A("",!0)]),m&&f.type==="full"?(g(),p("div",oe,[(g(),p(L,null,$(m,d=>Y(U,{key:d,class:T({invert:o.value}),color:"teal",rounded:"",size:"large",variant:"outlined",onClick:I=>W(d)},{default:D(()=>[G(F(d),1)]),_:2},1032,["class","onClick"])),64))])):A("",!0),f.type==="full"?(g(),p("div",ie,[Y(U,{class:"mr-5",variant:"outlined",onClick:v},{default:D(()=>h[0]||(h[0]=[G(" Cancel ")])),_:1}),Y(U,{color:"primary",variant:"outlined",class:T({invert:o.value}),onClick:O},{default:D(()=>h[1]||(h[1]=[G(" Search ")])),_:1},8,["class"])])):A("",!0)])],2)):A("",!0)}}),We=nt(ae,[["__scopeId","data-v-e4b91679"]]);var rt;(function(t){t.STRING="string",t.NUMBER="number",t.INTEGER="integer",t.BOOLEAN="boolean",t.ARRAY="array",t.OBJECT="object"})(rt||(rt={}));/**
 * @license
...
`)),s=S(()=>n.value.map(r=>!t.searcher||t.searcher.isEmpty?[r]:Ft(r,t.searcher.regex))),o=S(()=>t.lineName===V.title),i=S(()=>!t.lineName||t.lineName===V.textus),a=S(()=>t.lineName===V.versio),l=S(()=>({"line-title":o.value,textus:i.value,versio:a.value}));return(r,E)=>(g(),p("div",{class:T([l.value,"grep-line"])},[(g(!0),p(L,null,$(s.value,(m,y)=>(g(),p("div",{key:y},[(g(!0),p(L,null,$(m,(c,u)=>(g(),p("span",{key:u,class:T({highlight:u%2,invert:tt(e)})},F(c),3))),128))]))),128)),r.translationLanguage?(g(),Z(Be,{key:0,languages:[r.translationLanguage],str:r.str},null,8,["languages","str"])):A("",!0)],2))}}),Xe=nt(He,[["__scopeId","data-v-1e986bbd"]]);export{Je as D,Xe as G,We as K,P as L,ze as S,Pe as a,jt as b,z as c,Pt as s,Vt as u};
