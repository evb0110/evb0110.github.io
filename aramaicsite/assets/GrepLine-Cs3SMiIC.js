var xt=Object.defineProperty;var kt=(t,e,n)=>e in t?xt(t,e,{enumerable:!0,configurable:!0,writable:!0,value:n}):t[e]=n;var X=(t,e,n)=>kt(t,typeof e!="symbol"?e+"":e,n);import{M as q,c as S,a4 as Lt,b as et,aw as wt,t as Dt,r as I,w as it,b3 as Gt,o as g,f as p,n as at,D as Z,A as Ut,p as A,F as L,i as $,g as Y,h as D,j as G,k as F,ax as T,V as U,m as tt,_ as nt}from"./index-CNUuKXrP.js";import{V as $t}from"./VTextField-BA1DVZjU.js";import{b as Ft}from"./betterSplit-CW8NIeFU.js";var V=(t=>(t.title="title",t.textus="textus",t.versio="versio",t))(V||{});const Pe=["title","textus","versio"];var jt=(t=>(t.search="search",t.browse="browse",t))(jt||{});const Je=["search","browse"],Bt="(?:a|e|i|iͧ|o|u|ä|å|ë|ö|ü|á|á̧|â|ä|å|é|ê|ë|í|î|ó|ô|ö|ú|û|ü|ā|ā́|ă|ą̂|ē|ĕ|ī|ı|ō|ŏ|ū|ŭ|ŭ́|ə|ə́|и|о|ю|ạ|ạ|ạ́|ậ|ắ|ẹ|ọ|ộ|ụ|ụ̂|а|о|у|э|ы|и|ь)",Ht="(?:b|b́|c|c̄|d|f|f̣|g|h|j|k|k̇|l|m|n|n̄|p|p̄|p̣|q|q̣|r|r̄|r̄̄|s|s̄|t|t́|v|w|x|y|z|z̄|ç|ć|č|ğ|ġ|ģ|ķ|ń|ň|ŕ|ś|ŝ|ş|ş́|ş̇|š|ţ|ž|ǧ|ǧ̣|Ɂ|ɧ|ʔ|ʕ|ʕ́|ʕ̣|ʾ|ʿ|б|в|й|к|п|р|с|т|х|ҫ|ҫ́|ҫ̂|ҫ̄|ع|ḅ|ḇ|ḉ|ḍ|ḏ|ḏ̣|ḏ̣̣|ḥ|ḳ|ḳ̇|ḷ|ṃ|ṅ|ṇ|ṗ|ṛ|ṝ|ṡ|ṣ|ṫ|ṭ|ṯ|ẓ|ẖ|ﻉ)",Kt=new RegExp("[\\\\]v","gi"),Yt=new RegExp("[\\\\]c","gi"),qt=q.memoize(function(e){return e.replace(Kt,Bt).replace(Yt,Ht)});class z{constructor(e){X(this,"_value");this._value=e||""}get value(){return this._value}set value(e){this._value=e||""}get valueNormalized(){return qt(this.value)}get isEmpty(){return!this.value}get regex(){return RegExp(this.valueNormalized,"iu")}static instantiate(e){return new z(e)}}class ze{constructor(e){X(this,"data");this.data=q.mapValues(e,z.instantiate)}get searchersArr(){return q.values(this.data)}get areAllEmpty(){return this.searchersArr.every(e=>e.isEmpty)}get test(){return e=>q.keys(this.data).every(n=>this.data[n].regex.test(e[n]))}}var P=(t=>(t.turoyo="turoyo",t.urmi="urmi",t.maalula="maalula",t))(P||{});const Vt=()=>{const t=Lt();return S(()=>t.path.split("/")[1])};function Pt(t){return new Promise(e=>setTimeout(e,t))}const Jt="a á ä ā b ḅ c č ç d ḍ ḏ ḏ̣ e é ē ə f g ǧ ġ ģ h ḥ i í î ī ı j k ḳ l m ṃ ň ṇ o ó ö p q r ṛ s š ṡ ş ṣ t ţ ṭ ṯ u ú ü ụ v w x y z ž ʔ ʕ",zt=Jt.split(/\s+/),Wt="a ä b ʙ c č ç d e ǝ ə f g Ģ h i I ı j k l m n o ö p q r s ş ṣ ș t ţ ṭ ț u ü v w x y z ž ƶ а ә б в г д е ж з и й к л м н о п р с т у ф х һ ц ч ш щ ъ ы ь э ю я",Xt=Wt.split(/\s+/),Qt="ʔ ʕ a á ā b c ć č d ḍ ḏ ḏ̣ e é ē ə f g ǧ ġ h ḥ i í ī k ḳ l ḷ m n o ō p r s š ṣ t ṭ ṯ u ú ū w x y z ž ẓ",Zt=Qt.split(/\s+/),te={[P.turoyo]:zt,[P.urmi]:Xt,[P.maalula]:Zt},ee=()=>{const t=Vt();return S(()=>te[t.value])},ne={class:"working-block"},se={class:"keyboard specific-keys"},oe={key:1,class:"keyboard common-keys"},ie={key:2,class:"submit-wrapper"},ae=et({__name:"Keyboard",props:{value:{default:""},inputName:{default:""},visible:{type:Boolean,default:!1},type:{default:"full"},inputEl:{default:null}},emits:["submit","update:visible"],setup(t,{emit:e}){const n=e,s=wt(),o=Dt(s,"isDark"),i=I(0),a=I(0),l=I(null),r=I(t.value),E=[String.raw`\v`,String.raw`\c`,"^","$","\\"],m=["⬅","space","del","backspace","⮕"],y=ee(),c=I(null);it(()=>{c.value=l.value||t.inputEl},{flush:"sync"}),it(()=>{r.value=t.value});function u(h){r.value=h,ot()}function v(){n("update:visible",!1)}function _(){n("submit",r.value),console.log("submit",r.value),v()}function ot(){var h,d;i.value=((h=c.value)==null?void 0:h.selectionStart)||0,a.value=((d=c.value)==null?void 0:d.selectionEnd)||0}async function Tt(){await Pt(20),ot()}function W(h){if(!c.value)return;const d=r.value||"";i.value=c.value.selectionStart||0,a.value=c.value.selectionEnd||0;const{buttonValueMod:f,selectionStartMod:R,selectionEndMod:O}=Mt({buttonValue:h,selectionStart:i.value,selectionEnd:a.value,existingValue:d});c.value.value=d.slice(0,R)+f+d.slice(O,d.length),r.value=c.value.value,c.value.focus(),i.value=c.value.selectionStart=R+f.length,a.value=c.value.selectionEnd=R+f.length,t.type==="regex"&&(console.log("submit",r.value),n("submit",r.value))}Gt(()=>{l.value=document.querySelector(".keyboard-wrapper .v-text-field input"),i.value=a.value=t.value.length});function Mt({buttonValue:h,selectionStart:d,selectionEnd:f,existingValue:R}){let O,w=d,x=f;return h==="backspace"?(d>0&&d===f&&(w=d-1),O=""):h==="del"?(d<R.length&&d===f&&(x=f+1),O=""):h==="space"?O=" ":h==="⬅"?(d<f?x=d:(w=Math.max(0,d-1),x=w),O=""):h==="⮕"?(d<f?w=f:(w=Math.min(R.length,d+1),x=w),O=""):(O=h,w=d,x=f),{buttonValueMod:O,selectionStartMod:w,selectionEndMod:x}}return(h,d)=>h.visible?(g(),p("div",{key:0,class:T([h.type,"keyboard-wrapper"])},[at("div",ne,[h.type==="full"?(g(),Z($t,{key:0,label:h.inputName,"model-value":r.value,class:"input",density:"compact",variant:"outlined",clearable:"",onFocus:Tt,"onUpdate:modelValue":u,onKeyup:Ut(_,["enter","native"])},null,8,["label","model-value"])):A("",!0),at("div",se,[E?(g(),p(L,{key:0},$(E,f=>Y(U,{key:f,color:"warning",variant:"outlined",class:T({invert:o.value}),rounded:"",onClick:R=>W(f)},{default:D(()=>[G(F(f),1)]),_:2},1032,["class","onClick"])),64)):A("",!0),tt(y)&&h.type==="full"?(g(!0),p(L,{key:1},$(tt(y),f=>(g(),Z(U,{key:f,variant:"outlined",rounded:"",onClick:R=>W(f)},{default:D(()=>[G(F(f),1)]),_:2},1032,["onClick"]))),128)):A("",!0)]),m&&h.type==="full"?(g(),p("div",oe,[(g(),p(L,null,$(m,f=>Y(U,{key:f,class:T({invert:o.value}),color:"teal",rounded:"",size:"large",variant:"outlined",onClick:R=>W(f)},{default:D(()=>[G(F(f),1)]),_:2},1032,["class","onClick"])),64))])):A("",!0),h.type==="full"?(g(),p("div",ie,[Y(U,{class:"mr-5",variant:"outlined",onClick:v},{default:D(()=>d[0]||(d[0]=[G(" Cancel ")])),_:1}),Y(U,{color:"primary",variant:"outlined",class:T({invert:o.value}),onClick:_},{default:D(()=>d[1]||(d[1]=[G(" Search ")])),_:1},8,["class"])])):A("",!0)])],2)):A("",!0)}}),We=nt(ae,[["__scopeId","data-v-9c00a71f"]]);var rt;(function(t){t.STRING="string",t.NUMBER="number",t.INTEGER="integer",t.BOOLEAN="boolean",t.ARRAY="array",t.OBJECT="object"})(rt||(rt={}));/**
 * @license
